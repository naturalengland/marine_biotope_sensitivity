...
load.gis.attrib <- function(gis.attr = hab_map){ #hab.map is the habitat map that was read in 03_read_spatial_habitat_data #old function: attr = hab_map@data used to work wth readOGR
