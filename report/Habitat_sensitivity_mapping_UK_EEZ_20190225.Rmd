...
Standardization according to benchmark.
...
In this report a case study was developed to inspect the application of the habitat sensitivity mapping in relation to spatial maps of fishing activity. The **aim 1.2** of the case study was  to identify a) sensitive and not-fished, and b) not-sensivite and not-fished areas, as a potential source to inform management of options which identifies the spatial distribution of fishing effort whcih would minimise the their impact on the benthic habitat. 

Fishing activities have had profound effects on the UK's marine ecosystem, of which bottom towed fishing gears is one of the most damaging activities which altered benthic habitats, composition and trophic structure of fish and invertebrate communities over the last century of industrial fishing [@kaiserChangesMegafaunalBenthic1998; @jenningsImpactsTrawlingDisturbance2001; @hiddinkCumulativeImpactsSeabed2006; @tillinChronicBottomTrawling2006; @thurstanEffects118Years2010]. The objective of the case study was to quatify the proporton of low, medium and highly sensitive habitat currently under abrasion pressure from three bottom towed fishing gears a) dredging, b) beam trawl and c) ...*(see Duncan's email to JNCC)* activities in the English seabed 0 - 220 NM offshore.

The aim of the case study to evaluate the use of sensitivity mapping as a tool to inform management of options to identify the areas minimise the impacts of a the spatial distribution of fishing activities. The habitat sensitivity maps were therefore evaluated as an data set to inform conservation advice in the event of displacement of fishing effort. The ability of the tool to identify recently non-fished sensitive benthic habitats were explored, as a means to inform spatial planning in the UK's EEZ. 
