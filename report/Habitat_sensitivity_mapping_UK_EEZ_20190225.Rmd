...
In recognition that impacts from displacement of fishing effort occurring outside of MPAs can have an impact on features within MPAs, a "wider-seas" and "whole-sites" approach was used to assess the sensitivity of benthic habitats to fishing activities for the entire EEZ. The whole-sites and wider-seas approach means that currently protected features were not considered in isolation, but that the connectivity between benthic habitats were considered to provide a holistic overview the spatial distributions of fishing related impacts on the benthic habitat.The sensitivity of marine habitat has been defined as sensitivity as *"the degree to which marine features respond to stresses, which are deviations of environmental conditions beyond the expected range"* [Sensitivity and Vulnerability in Marine Environments: an Approach to Identifying Vulnerable Marine Areas](https://0-onlinelibrary.wiley.com.wam.seals.ac.za/doi/full/10.1111/j.1523-1739.2005.00148.x). Previous efforts to map out geogrpahical distribution of habitat sensitivity have been critisised for being score based or expert judged systems Tyler Walters 1999, Zacharias and [Assessing and predicting the relative ecological impacts of disturbance on habitats with different sensitivities](https://0-besjournals.onlinelibrary.wiley.com.wam.seals.ac.za/doi/full/10.1111/j.1365-2664.2007.01274.x). Those studies which have developed 
