...
In this report a case study investigating some basic uses of habitat sensitivity maps with respect to abrasion pressures from scallop dredging in English marine waters were used to illustrate potential application of such habitat sensitivity maps to investigate the impacts and spatial management options for damaging fisheries. The case study showed that habitat sensitivity maps were able to identify the level of sensitivity and type of benthic habitat impacted on by abrasive pressures from scallop dredging. Within the areas where scallop dredging activities were greatest, it was clear that there was substantial variation in the sensitivities between dredged habitats. The ability to map sensitive areas and the areas used for such fishing activities provides the critical information to marine managers to inform and improve spatial management through regulations which restrict dredging activities to the habitat types that are least sensitive to fishing impacts.

## Case study
The impacts of scallop dredging on King (*Pecten maximus*) and Queen scallops (*Aequipecten opercularis*) (insert Howarth report and more papers), and concerns over the degradation effects on the benthic habitat and the associated invertebrate community suggests that a wide range of habitats, including soft sediment and hard benthic habitat substrates *insert some references*. It is important to understand the overlap of these activities and the distribution of sensitive benthic habitats to manage to damage to the habitats which are resilient to the impacts of dredging and have the shortest time to recovery. The results from this case study shows the potential for sensitive benthic habitats to identify options for scallop fishing management.
