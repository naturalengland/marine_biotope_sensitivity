...
*Only the inshore is shown at this stage. the offshore will be added once JNCC project data is included, with reference to:* [@tillinAssiningEUNISClassification2017]
...
The confidence of the sensitivity assessments for the inshore and offshore based on the quality of the evidence is shown in Figure 10. The confidence map showed that generally the quality of evidence was higher for habitats assessed in the inshore than offshore areas. The English channel generally had relatively high levels of confidence associated with sensitivity assessments. (this may change when a sub-biogeoregional approach is incorporated for the offshore habitats.)
...
## Scallop dredging activity in sensitive benthic habitat
...
<br>
A 100 by 100m grid of randomly stratified points were overlaid over the inshore benthic habiat sensitivity map to sample the proportion of sensitivity habitat this. The majority (58 %) of inshore area under high levels of scallop dredging  activity  (more than 10 passess between 2009 and 2014) was of low sensitivity. A third of the area consisted of habitats with medium levels of sensitivity, and about 9 % consisted of highly sensitve habitats which were under high levels of scallop dredging activity. 
<br>
The largest concentration of effor on highly sensitive habitat is in the area between Falmouth to Plymouth. This sensitivty was informed by fine-scale benthic habitat A5.421 attributed to a large polygon on the habitat map offically classified as habitat type A5.4.
