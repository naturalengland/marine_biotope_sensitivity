...
In this project, fine-scale habitats nested within broad-scale habitats are of the same origin (as in the example above) and are hierarchical. A fine-scale habitats within broad-scale habitats of the same origin is referred to as "child" fine-scale habitat within a "parent" broad-scale habitat, indicating this hierarchical and related relationship.
