...
dat <- hm_sens_habs[!(hm_sens_habs$`Assessed habitat` == "A4.231" & hm_sens_habs$sens_Z10_5_D6 == 6),]

#hm_sens_habs %>% dplyr::filter(!`Assessed habitat` == "A4.231" & !sens_Z10_5_D6 == 6) %>% 
dat %>% 
...
In this report a case study investigating some basic uses of habitat sensitivity maps with respect to abrasion pressures from scallop dredging in English marine waters were used to illustrate potential application of such habitat sensitivity maps as a starting point to management of fising effort dispalcement. While this study did not assess displaced fishing effort *per se*, it provides the baseline information which may be used to inform the suitability of in the event a change in regulations that could lead to a displacement of fishing effort.
...
## Case study
The impacts of the dredge fishery for King (*Pecten maximus*) and Queen scallops (*Aequipecten opercularis*) [@howarthDredgeFisheryScallops2014], and concerns over the degradation effects on the benthic habitat and the associated invertebrate community suggests that a wide range of habitats, including soft sediment and hard benthic habitat substrates [@currieImpactsEfficiencyScallop1999; @hall-spencerScallopDredgingHas2000; @jenkinsImpactScallopDredging2001; @thrushsfImpactHabitatDisturbance1995]. It is important to understand the overlap of fishing activities and the distribution of sensitive benthic habitats to direct fishing activities to the habitats which are most resilient to the impacts and have the shortest time to recovery. The results from this case study shows the use of benthic habitat sensitivity maps to identify the habitats within historical core scallop dredging areas which require management intervention to prevent significant long-term damage to habitats and change to benthic invertebrate communities.

### Inshore benthic habitat senstivity
Eight highly sensitive inshore benthic habitats are currently likely to be impacted on by scallop dredging activities. Four of these included infra and sub-tidal circalittoral rock habitats with algal or invertebrate communities which are not compatible with scallop dredging gear, and would suffer significant damage if dredged. The remaining four highly sensitive benthic habitats were sedimentary characterised by annelid, crustacean or cnidarian invertebrate communities which are had slow recovery periods and high levels of mortality associated with abrasion from scallop dredging. Of particular concern were *Phymatolithon calcareum* mearl beds which have been shown to undergo significant long term declines with no recovery after 4 years following scallop dredging in a previous study in the English Channel [@hall-spencerScallopDredgingHas2000].

### Offshore benthic habitats
The lack of highly sensitive offshore benthic habitats was surprising given the precautionary approach followed to determine fine-scale child habitats within broad-scale benthic habitats.  - and how realistic is it that they were impacted?/how are they impacted?

The offshore habitats used in this study lacked sub-biogeoregion classification as that was used for the inshore areas. This lack of sub-biogeoregion meant that all potential fine-scale (child) benthic habitats occurring within broader scale (parent) habitats were considered for each (parent) broad-scale habitat. The resulting sensitivity map for the offshore was therefore the maximum sensitivity associated with all possible fine-scale child habitats which were used to replace their mapped broad-scale parent habitats. It is unlikely that all fine-scale child habitats occur within all broad-scale parent habitats. Consequently it is highly likely that offshore sensitivity map is an over-estimate of the actual sensitivity of the mapped broad-scale habitats.While the precautionary principal is essential for effective conservation, sub-biogeoregion information will greatly improve the accuracy of the predicted fine-scale child habitats within the broad-scale habitats. Greater accuracy of offshore habitat maps will improve the ability to identify areas with high levels of sensitivity, and the confidence with which conservation advice can be provided in the offshore. A study of the sub-biogeoregions of the offshore area is currently being developed by JNCC and should be incorporated within the NE's models in due course.
