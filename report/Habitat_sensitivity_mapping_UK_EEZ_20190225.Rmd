...
*The use of "parent" and "child" when refering to the nested hierarchy of fine-scale habitats within broad-scale habitats, is used to describe the nested fine-scale (child) habitats which include the same EUNIS codes as the parent habitat under which it is nested.

Designated habitat features are represented at an intermediate scale of detail, equivalent to EUNIS level 3. Natural England's conservation advice is therefore limited to a subset of the area of English Territorial Waters, and provided at a coarser scale of habitat detail than is available for a substantial area of the UK seabed. Natural England holds a bespoke dataset which details potential fine-scale habitats (EUNIS level 4 - 6) which occur within the broader habitat categories (EUNIS level 1 - 3) within the sub-biogeographical sea regions in the inshore waters of England from 0 to 12 NM. The bespoke dataset was informed through expert consultation with Dr Keith Hiscock from the Marine Biological Association [@hiscockAssigningEUNISClassification2016]. There is currently work commissioned by JNCC which is identifying fine-scale habitats within broad-scale habits in the offshore (12 - 200 NM) using the same methodology. The latter data set will become incorporated into the overall data set in due course, but was not ready for implementation at the time of writing. 
...
<br>
Fishing activities have had profound effects on the UK's marine ecosystem, of which bottom towed fishing gears is one of the most damaging activities which altered benthic habitats, composition and trophic structure of fish and invertebrate communities over the last century of industrial fishing [@kaiserChangesMegafaunalBenthic1998; @jenningsImpactsTrawlingDisturbance2001; @hiddinkCumulativeImpactsSeabed2006; @tillinChronicBottomTrawling2006; @thurstanEffects118Years2010]. Bottom towed fishing gears impact the habitat through penetration of the seabed, abrasion as the gear is being towed, and sedimentation caused in the wake of the towed gear [@oneillPhysicalImpactTowed2016]. The impact of dredge fishery targetting King (*Pecten maximus*) and Queen scallops (*Aequipecten opercularis*) on sensitive benthic habitat it is of particular concern. Scallop dredging causes significant long-term degradation of the benthic habitat and the associated invertebrate communities. The impacts of scallop dredging include a wide range of habitats, including soft sediment and hard benthic habitat substrates [@currieImpactsEfficiencyScallop1999; @hall-spencerScallopDredgingHas2000; @jenkinsImpactScallopDredging2001; @thrushsfImpactHabitatDisturbance1995].

For these reasons, the sensitivity of benthic habitats to  scallop dredging was focussed on in the case study. The objective of the case study was to quantify the proportion of low, medium and highly sensitive habitat currently under three pressures, including, i) penetration, ii) abrasion and iii) sedimentation, from  scallop dredging. b) demersal otter trawling, and c) beam trawl activities in English waters. Furthermore, benthic habitat sensitivity to other damaging bottom towed gears were mapped, to illustrate the wider application of habitat senstivity maps, which extend beyond the case study.
...
In this report a case study investigating the use of benthic habitat sensitivity to abrasive pressures from scallop dredging in English marine waters was used to illustrate potential application of such habitat sensitivity maps as a starting point to management of fising effort displacement. While this study did not assess displaced fishing effort *per se*, it provides the baseline information which can inform the suitability and potential impacts arising from a displacement of fishing effort.

The case study showed that habitat sensitivity maps were able to identify the level of sensitivity and type of benthic habitat impacted on by abrasive pressures from areas under substantial scallop dredging pressure. The high levels of variation of habitat sensitivity within dredged areas suggests fishery management intervention may reduce the impact on sensitive habitats. The ability to map sensitive areas threfore provides critical information to marine managers to inform and improve spatial management through regulations which restrict dredging activities to the habitat types that are least sensitive to fishing impacts.It is important to understand the overlap of fishing activities and the distribution of sensitive benthic habitats to direct fishing activities to the habitats which are most resilient to the impacts and have the shortest time to recovery. The results from this case study shows the use of benthic habitat sensitivity maps to identify the habitats within historical core scallop dredging areas which require management intervention to prevent significant long-term damage to habitats and change to benthic invertebrate communities.

## Inshore benthic habitat senstivity
The results from this stidy showed that there were seven highly sensitive inshore benthic habitats which have been impacted on by scallop dredging activities. Four of these habitats included infra and sub-tidal circalittoral rock habitats with algal or invertebrate communities which are not compatible with scallop dredging gear, and would suffer significant damage if dredged. The remaining four highly sensitive benthic habitats were sedimentary characterised by annelid, crustacean or cnidarian invertebrate communities which are had slow recovery periods and high levels of mortality associated with abrasion from scallop dredging. Of particular concern were *Phymatolithon calcareum* mearl beds which have been shown to undergo significant long term declines with no recovery after 4 years following scallop dredging in a previous study in the English Channel [@hall-spencerScallopDredgingHas2000].

## Offshore benthic habitats
The lack of highly sensitive offshore benthic habitats was surprising given the precautionary approach followed to determine fine-scale child habitats within broad-scale benthic habitats. This lack of sub-biogeoregion meant that all potential fine-scale (child) benthic habitats occurring within broader scale (parent) habitats were considered for each (parent) broad-scale habitat. The resulting sensitivity map for the offshore was therefore the maximum sensitivity associated with all possible fine-scale child habitats which were used to replace their mapped broad-scale parent habitats. It is unlikely that all fine-scale child habitats occur within all broad-scale parent habitats. Consequently it is highly likely that offshore sensitivity map is an over-estimate of the actual sensitivity of the mapped broad-scale habitats. While the precautionary principal is essential for effective conservation, sub-biogeoregion information will greatly improve the accuracy of the predicted fine-scale child habitats within the broad-scale habitats.

In the offshore, no sub-biogeoregional restrictions of potential child habitats occuring within their parent habitats were applied, and therefore highly sensitivite habitats were expected to be highly prevalent in the offshore. Yet, large areas were not regarded as highly senstive. This may be explained by the inherent lower senstivity of general offshore habitat, but further investigation is required to udnerstand the offshore habitat sensitivity bettter. Increasing knowledge of offshore benthic habitat is paramount to providing any further resolution on the offshore sensitivity mapping. The sub-biogeoregional mapping undertaken by JNCC along with the identification of likely fine-scale habitats within broad-scale habitats in the offshore [@tillinAssiningEUNISClassification2017]. Furthermore, greater accuracy of offshore habitat maps will improve the ability to identify areas with high levels of sensitivity, and the confidence with which conservation advice can be provided in the offshore.

## Confidence in the modelled habitats
The confidence with which modelled fine-scale child habitats could be assigned to broad-scale parent habitats has not yet been assessed. However, these assignments are based on the subbiogeoregional habitat classification  

## Activity data
The fishing data used in this study were based on VMS data from English waters covering the period between 2009 and 2014, and will require updating to illustrate the present scenario. The data available to this study were received as aggregated into broad gear categories, which required separating scalloping from other kinds of dredging activities. Greater access to recent VMS data with a finer  level of aggregation will facilitate better discrimination between the habitats and their sensitivities impacted on by different metiers.

Fishing activity data used in this case study were limited to VMS data, and did not include the vessels smaller than 12, as these vessels are not fitted with VMS. The smaller fishing fleet generally operates in the waters inshore from 12 NM boundary but is generally not well understood. Previous efforts which mapped the fishing effort were based on qualitative descriptions from interviews with fishermen which are becoming increasingly outdated and thus have limited application. In order for objective inspection of the impacts that the inshore fishing fleet is having on the benthic substrate, higher resolution and objective data are required. 

Areas considered to have high levels of dredging activity inside them were those with  more than 10.8 passes during  the 2009 to 2014 period. The estimated areas impacted by scallop dredging are therefore likely to be significantly under-estimated, as a single dredge can cause damage to habitat; with the first dredge often doing the most damage (*insert reference*).
...
```{r flowdiagram, fig.cap="Flow diagram of data processing in R.",echo = FALSE}
