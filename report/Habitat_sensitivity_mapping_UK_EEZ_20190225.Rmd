...
```{r cross_tbaulate_resist_resil, Fig_caption = "Table 6. The combination of resistance and resilience scores to categorize sensitivity.", echo = FALSE}
...
There is a mismatch in the habitat categories included in the habiat map and those that have been assessed for sensitivity to pressures. The habitat map includes EUNIS level 2 - 6, while the assessmetns only cover EUNIS level 4 - 6.
