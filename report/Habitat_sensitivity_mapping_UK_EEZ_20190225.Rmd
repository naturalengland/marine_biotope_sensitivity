...
The spatial match of scallop fishing activity was compared to the distribution of sensitive habitats.
Scalloping data were obtained from VMS records. The number of records per habitat-sensitivity category were provided, along with mapped outputs to illustrate the potential application of sensitivity maps. The habitat sensitivity map was developed for abrasion from dredging for the UK's EEZ, using the two step process described above. A fishing pressure layer for dredging **and the current MPA layer** was overlaid onto the habitat sensitivity map to investigate 1.) the overlap of dredging activities on habitats which are sensitive thereto, 2. ) the placement of MPAs in relation to the impacts on sensitive benthic habitats.
