...
## Study Area
Marine habitat sensitivity maps were generated for the United Kingdom's Exclusive Economic Zone (EEZ), from the shoreline to 200 NM offshore. The sensitivity maps were generated in two indepednent steps for two geographical adjacent areas: First for 0 - 12 NM offshore for English territorial waters (area in light blue in Figure 1), and second, the 12 - 200 NM English offshore. The second step included the Devolved Administration's waters from 0 - 200 NM for (Figure 1). Note that Develoved Adminstrations were produced as an artefact of the process, and no attempt was made to analyse or interpret this data. These areas will subsequently be removed from outputs.
...
<br>
The majority of the total area of the offshore marine environment (53.2 %) was dominated by medium level senstivity to abrasion from dredging. Almost 28.8 % percent of the total offshore area was not assessed, and the remaining area was comprised of 16.6 % low sensitvity and 1.2 % high sensitivity.
...
The confidence of the sensitivity assessments for the inshore and offshore based on the quality of the evidence is shown in Figure 10. The confidence map showed that generally the quality of evidence was higher for habitats assessed in the inshore than offshore areas. The English channel generally had relatively high levels of confidence assocaited with sensitivity assessments. (this may change when a subbioregional aproach is incorporated for the offshore habitats.)
