...
A fishing activity layer showing dredging and the current Marine Conservation Zone (MCZ) layer shows the placement of MCZs in relation to the fishing activity.
...
In total about 390 benthic habitat sensitivity maps were produced for 39 pressures from the ten fishing activities, for the inshore and for the offshore resepctively.
Output maps were vector based, and mirror the spatial resolution and habitat detail of the benthic habitat map.

## Case study results

1. The spatial distribution of benthic habitat sensitivity to abrasion from dredging is shown in Figure 6.
...
```{r hab_sens_dredge_abras, fig.cap= "Figure 6: The benthic habitat sensitivity to abrsation from dredging activities in the UK's Exclusive Economic Zone (EEZ)", echo = FALSE}
