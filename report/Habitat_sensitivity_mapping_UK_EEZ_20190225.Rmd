...
Natural England's exiting conservation advice database, PD_AoO.accdb, houses sensitivity assessments for all biotopes in English territorial waters. The sensitivity assessments are based upon the MarESA *REF: Tillen et al/MarESA* methods. the methodology uses a standardised approach in which each biotope (formally recognised) was assessed against the *Pressures* arising from 

#### 2. Marine biotope map
