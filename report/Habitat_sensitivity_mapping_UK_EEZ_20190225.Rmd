...
## Study Area
The area for which sensitivity maps were genereated covers the United Kingdom's Exclusive Economic Zone (EEZ) 

Objective 1

Natural Englands exiting conservation advice database, which houses sensitivity assessments for all biotopes in English territorial waters, will be used in conjunction with existing benthic habitat maps to derive sensitivity maps for benthic habitat.
