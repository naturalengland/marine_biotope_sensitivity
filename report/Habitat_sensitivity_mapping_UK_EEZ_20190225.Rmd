...
*The use of "parent" and "child" when referring to the nested hierarchy of fine-scale habitats within broad-scale habitats, is used to describe the nested fine-scale (child) habitats which include the same EUNIS codes as the parent habitat under which it is nested.
