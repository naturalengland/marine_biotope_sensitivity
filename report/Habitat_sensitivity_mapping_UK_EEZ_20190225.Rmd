...
abstract: "The variety of benthic habitats in English waters differ in their degree of senstivity to pressures from fishing activities. Information on the spatial distribution of sensitive benthic habiats is therefore an essential dataset to inform  management of fishing activities in English waters. This project aimed to delineate the geographical distribution of the benthic habitat sensitivity to fishing activities that impact the seabed in England's waters. A script was developed in R statistical software to automate the process of assiginging fine-scale habitats and their sensitivities to the mapped broader-scale habitats within which these occur in English seas from the shore to the continental shelf-edge. In the inshore (0 - 12 NM), fine-scale habitat assignment to broad-scale habitats was based on previous work which determined the likely fine-scale habitats within each sub-biogeoregion. Two confidence estimates error associated to the outputs, namely the accuracy of the underlying habitat map (MESH score), 2) the confidence of the sensitivty assessment of the habitat itself (Quality of Evidence). A case study was developed to illustrate the application of benthic habitat sensitivity maps as an evidence base which can inform marine management decisions. In the case study, the spatial distribution of five areas with high levels (more than 10 passes between 2009 and 2014) of scallop dredging (considered the most damaging fishing activity on the seabed) were mapped and overlaid onto the habitat sensitivity maps for further analysis. Mapped outputs were produced for habitat sensitivity against three standadrised pressures, incluiding abrasion, penetration and siltation. Areas with relatively high levels of abrasive pressure from scallop dredging in the inshore (0 - 12 NM) were shown to overlap with habitat of which  58 % were of low sensitivity, a third of of medium sensitivity and a further 9 % of high sensitivity. In the offshore (12 - 200 NM) the overlap with abrasion from dredging was 96 % of with low sensitivity habitat, and the remaining 4 % overlapped with habitat with levels of medium sensitivity. Seven habitat types with high levels of sensitivity to abrasion were identified, including [Phymatolithon calcareum] maerl beds in infralittoral clean gravel or coarse sand. Variability in sensitivity of habitat within dredged areas suggests that management measuyres may be able to improve impacts on the seabed within dredged areas. Furthermore, the outputs provide an evidence base to direct a displacement of fishing effort away from the most sensitive benthic habitas."
...
```
# Introduction
Delineating the geographical distribution of habitat sensitivity has been identified as critical dataset for managing human activities on the marine environment [@baxSeabedHabitatSoutheastern2001]. The sensitivity of marine habitats have previously been defined as: *"The intolerance of a species or habitat to damage from an external factor and the time taken for its subsequent recovery"*, [@laffoleyNationallyImportantSeascapes2000; @tyler-waltersImpactHumanActivities2005] or, *"the degree to which marine features respond to stresses, which are deviations of environmental conditions beyond the expected range"* [@zachariasSensitivityVulnerabilityMarine2005]. Overfishing and habitat loss are regarded as two of the main contributors to the degradation of the UK's marine environment [@walportForesightFutureSea2017]. Benthic habitats differ in their degree of sensitivity to  pressures arising from the various fishing activities [@dupliseaSizebasedModelImpacts2002; @hiddinkAssessingPredictingRelative2007], and therefore understanding the geographical distribution of habitat sensitivity has significant potential to inform spatial management of fishing activities in the marine environment. 

Commercial fishing operations are wide spread throughout the United Kingdom, and is fished by both national and international fleets within the remits of the London Fisheries Convention (1964) and the Common Fishery Policy (CFP 1970s). The withdrawal of the UK from the European Union (EU exit/Brexit), [European Union (Withdrawal) Act 2018, section 20](http://www.legislation.gov.uk/ukpga/2018/16/section/20); [Article 50](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:12016M/TXT&from=EN), is likely to lead to change in fisheries regulations [@phillipsonSeaTroublesBrexit2018]. Leaving the EU may change how fish stocks are shared across political borders, quota allocation to EU-member states in the UK, and Total Allowable Catch (TAC) for different stocks among many other aspects related to managing the UK fishing grounds [@phillipsonSeaTroublesBrexit2018]. A change in fishing regulations may therefore have substantial ramifications for the management of fishing operations in the UK. The spatial distribution of fishing effort among various fishing metiers is a key element which is likely to be influenced by a change in regulations, known as a displacement of fishing effort [@vaughanFishingEffortDisplacement2017]. Previous research has shown that a displacement of fishing effort could lead to detrimental environmental and socio-economic effects e.g. [@stevensonSocioeconomicConsequencesFishing2013]. It is therefore important that the impact on the marine environment brought about by a displacement of fishing effort be considered prior to adopting new regulations or change in management practices [@vaughanFishingEffortDisplacement2017; @chollettQuantifyingSqueezingStretching2016]. Previous studies have developed tools to predict the impacts of fishing effort displacement, which forecast a change in the spatial distribution of fishing effort and the effort allocation between different fishing metiers [e.g., @bastardieDISPLACEDynamicIndividualbased2013]. Here it was not attempted to predict fishing effort displacement given the significant uncertainty and complexity in how Brexit would affect fishing opportunities and regulations throughout English waters. Instead, models showing the spatial distribution of benthic habitat sensitivity to fishing activities were developed. Habitat sensitivity mapping is a precautionary approach which could then be used to assess potential impacts from change in fishing activities as they happen or as they are proposed. Understanding the spatial distribution of benthic habitat senstivity is therefore essential to inform managers on the potential impact that a displacement of fishing effort may have on the seabed and thereby inform spatial management decisions.

## Natural England's role in the marine environment and the wider seas and whole-site approach
Natural England (NE), the Statutory Nature Conservation Body (SNCB) for English Territorial Waters (from the shore to 12 NM offshore), required maps of habitat sensitivity to inform the conservation advice on operations which it provides to Defra (Department for Environment, Food & Rural Affairs), regulators and developers. Natural England's statutory remit in the marine environment is principally directed towards protected habitats and species within English Territorial Waters, known as designated features. In many cases this remit relates to Marine Protected Areas (MPAs) and the features designated for protection within them [View the Designated Sites System online](https://designatedsites.naturalengland.org.uk/Marine/MarineSiteDetail.aspx?SiteCode=UKMCZ0045&SiteName=aln&countyCode=&responsiblePerson=&SeaArea=&IFCAArea=). Designated habitat features, as used by Natural England in its provisioning of conservation advice, are represented an intermediate level of detail, including the environment, biological and substrate type. the evidence base for Natural England's conservation advice is therefore limited to the subset of the area of English Territorial Waters which contain designated features. Furthermore, these designated features are defined at a coarser level of detail about the habitat than is available for a substantial area of the UK seabed. In recognition that impacts from a displacement of fishing effort occurring outside of MPAs can have an impact on features within MPAs, a "wider-seas" and "whole-sites" approach is required to assess the sensitivity of benthic habitats to fishing activities in English waters. A whole-sites and wider-seas approach means that protected features are not considered in isolation, but that the connectivity between benthic habitats is to be considered to provide a holistic overview when assessing the impacts of fishing related impacts on benthic habitat. 

## Previous sensitivity mapping work
Few studies have mapped habitat sensitivity for the entire inshore and offshore territorial waters of England or the United Kingdom [e.g. @fodenHumanPressuresUK2011], with the majority of studies mapping sensitivity for focus areas [e.g., @dupliseaSizebasedModelImpacts2002; @hiddinkAssessingPredictingRelative2007]. These studies limited benthic habitat sensitivity to four broad-scale categories, such as mud, muddy sand, sand and gravel [e.g., @dupliseaSizebasedModelImpacts2002; @hiddinkAssessingPredictingRelative2007; @fodenHumanPressuresUK2011]. Current quantitative models therefore do not consider differences in living structures and biological communities occurring within these habitats. These models are therefore likely to over- or under-estimate the sensitivity of fine-scale habitats within these very broad definitions of habitat. This lack of quantitative sensitivity models at a fine habitat scale is a result of limited quantitative data available for resilience and recovery of biological communities. On the other hand, methods using qualitative (score based or expert judged systems) to map out geographical distribution of habitat sensitivity [e.g., @tillinAssessingSensitivitySubtidal2014; @zachariasSensitivityVulnerabilityMarine2005] have been criticized for not being quantitative, and therefore not repeatable [@dupliseaSizebasedModelImpacts2002; @hiddinkAssessingPredictingRelative2007]. Despite these limitations, both quantitative and scored based systems of habitat sensitivity have commonly been based upon the same central tenet of resilience to pressures, and standardization of the pressures. [@robertsReviewExistingApproaches2010]. 

## Knowledge gap
Natural England required habitat sensitivity maps which inform the sensitivity of biological communities, for the all English Territorial waters, which were not available from previous work (at the time of writing). For these reasons, the qualitative aproach was followed, which allowed mapping of sensitivity at a scale which corresponds to the scale at which sensitivity assessments had been carried out. The qualitative evaluations used by Natural England and JNCC (the SNCB for the offshore environment in England) have not previously been mapped, and this project therefore attempts to address this knowledge gap and investigates its potential value as an evidence base to inform marine management decisions. 

## Project aims and objectives
The overarching aim of this project was to develop habitat sensitivity maps to serve as an evidence base for NE's conservation advice, and at the same time providing information about habitatat sensitivity at a finer scale of detail and a greater spatial extent than used at present to inform conservation advice.
<br>
The first specific objective was to map the spatial distribution of sensitivity of fine-scale benthic habitats, at EUNIS (European Nature Information System) level 4 - 6 (See the Annex for more detail), in relation to 39 standardised pressures caused by ten fishing activities within English waters. 
<br>
This project therefore used existing benthic habitat maps and sensitivity assessments of benthic habitat to derive maps of benthic habitat sensitivity for various pressures arising from ten fishing activities. The benthic habitat sensitivity assessments used in this project is the same data set used to inform Natural England's Conservation Advice (Advice on Operations) for designated features, including benthic habitats and species. The habitat sensitivity assessments are comprised of three principal components, namely 1) habitat, 2) activity, and 3) pressure. See the Background section in the Annex for more information on each of these components, and how sensitivity scores are derived following the MarESA protocol [@tyler-waltersMarineEvidencebasedSensitivity2018] as used by Natural England. Information on the sensitivity of benthic marine habitats and habitat maps are routinely updated every six months by Natural England through commisioned work. Furthermore, the large number of combinations of activities and pressures which impact the wide variety of benthic habitat types to a diffrent degree means that repeating the mapping process with each iterative update of the underlying data would be very resource intensive. In this project a script was developed in R statistical software to automate the developed habitat sensivity maps to all activities and pressures for which sensitivity assessments were available. 
<br>
The large amount of possible combinations of fishing activities and pressures, were distilled into a case study for this report to showcase a few key outputs and analyses as a proof of concept to illustrate the potential application of habitat sensitivity maps as essential data to inform decision making in the marine environment. The specific objectives of the case study were to identify the amount of sensitive benthic habitat and the type of benthic habitats currently impacted upon by scallop dredging activities within English waters.

## Case study description
Fishing activities have had profound effects on the UK's marine ecosystem, of which bottom towed fishing gears is one of the most damaging activities which have altered benthic habitats, composition and trophic structure of fish and invertebrate communities over the last century of industrial fishing [@kaiserChangesMegafaunalBenthic1998; @jenningsImpactsTrawlingDisturbance2001; @hiddinkCumulativeImpactsSeabed2006; @tillinChronicBottomTrawling2006; @thurstanEffects118Years2010]. Bottom towed fishing gears impact the habitat through penetration of the seabed, abrasion as the gear is being towed, and smothering from sedimentation caused in the wake of the towed gear [@oneillPhysicalImpactTowed2016]. The dredge fishery targeting King (*Pecten maximus*) and Queen scallops (*Aequipecten opercularis*) is of particular concern becuase its significant long term impacts on sensitive benthic habitat [@currieImpactsEfficiencyScallop1999; @howarthDredgeFisheryScallops2014]. Newhaven scallop dredges cause significant long-term degradation of the benthic habitat and the associated invertebrate communities [@howarthDredgeFisheryScallops2014] in a wide range of habitats, including soft sediment and hard benthic habitat substrates [@currieImpactsEfficiencyScallop1999; @hall-spencerScallopDredgingHas2000; @jenkinsImpactScallopDredging2001; @thrushImpactHabitatDisturbance1995]. Furthermore, the king scallop fishery is the most valuable single species fishery [@lawlerAssessmentScallopStock2019] and it does not have Total Allowable Catch (TAC) or quota limits [@curtisUKKingScallop2016]. This combination of highly incentivised activity without TAC or quota regulatios creates conditions which can intensivy and spread the significant impacts of the fishery to other areas. For these reasons, the sensitivity of benthic habitats to scallop dredging was focused on in the case study. The objective of the case study was to quantify the proportion of low, medium and highly sensitive habitat currently under three pressures, including, i) penetration, ii) abrasion and iii) sedimentation, from  scallop dredging. The types of sensitve benthic habitats that are impacted by scallop dredging are identified and discussed. Sensitivity to pressures from demersal trawling in English waters were mapped, to illustrate the wider application of habitat sensitivity maps, which were produced in this project, but not further analysed in this report.

# Methods

## Study Area
Marine habitat sensitivity maps were generated for English waters from the shoreline to the edge of the continental shelf, extending further offshore than the 200 NM offshore Exclusive Econommic Zone (EEZ) boundary. The production of habitat sensitivity maps were carried out separately for English Territorial Waters which include 0 - 12 NM offshore (area in dark green in Figure 1) and the offshore area from 12 NM offshore to the edge of the continental shelf in English waters (area in light blue in Figure 1). For ease of reference these two geographically adjacent areas are respectively referred to as the inshore and the offshore from here on. 
<br>

```{r english_waters, fig.cap="Figure 1. The United Kingdom's marine boundaries, showing English Territorial Waters (0 - 12 NM) and English offshore waters (12 NM - edge of the continental shelf.)." ,echo = FALSE, out.extra='style="background-color: #FFFFFF; padding:20px; display: inline-block;"'}
rpt_d <- getwd()
...
<br>
The English inshore and offshore areas were treated independently as NE holds fine-scale data on the composition of the inshore benthic habitats which was not available for the offshore at the time of writing. The fine-scale information on habitat composition was utilised in an additional step within the modelling routines, which allowed fine-scale habitat prediction within mapped broader-scale habitats. The fine-scale level habitat information was obtained from additional data and expert validation which describes the likely fine-scale habitats within sub-biogeoregions within English waters.

## Data sources
Two main data sets were used to map the sensitivities for the marine benthic habitats within English waters, including 1) habitat sensitivity assessments and 2) a marine habitat map of the English seabed. In essence, the two data sources shared a common field namely, the EUNIS habitat code, in the datasets and could therefore be joined to associate the sensitivity of habitat categories to the mapped habitat categories. The complexity of the actual process is described in greater detail in the Annex.

### Sensitivity assessments
Sensitivity assessments of each benthic habitat categories, as defined within the EUNIS classification system, have been carried out using the MarESA methods [@tillinAssessingSensitivitySubtidal2014] and is used as part of NE's ongoing Advice on Operations programme. The sensitivity of the EUNIS habitats levels 4 to 6 (biological community level information) were assessed against 39 standardised pressures for each activity. The ten fishing activities in the Advice on Operations database were included in this project (see Table 1). 

<br>
```{r fishing_acts, fig.cap="Table 1. Fishing activities for which sensitivity assessments were available in the Advice on Operations (AoO) database", echo = FALSE}
library(RODBC) 
library(DBI)
library(tidyverse)
...
tblActivityLUT %>% 
        ...
        select(`Activity Name` = ActivityName, Description) %>%
...
tblPressureLUT %>% 
        rename(`Pressure Code` = PressureCode, `Pressure Name` = PressureName) %>%
...
One of six levels of sensitivity (Table 3) were assigned to each habitat category in response to each of the 39 pressures. The sensitivity score was based on the resistance and resilience of the habitat to the pressure impacting upon it. See the Annex for tables and [@tillinAssessingSensitivitySubtidal2014] for details about the MarESA methods.
...
The data source for sensitivity assessment data is also stored internally at NE in a Microsoft Access database (version: created 22 June 2018), namely, PD_AoO.accdb, referred to as the sensitivity assessment database or just the database hereafter. This database was used as the source for the sensitivity assessments of the EUNIS habitats in relation to the activities and pressures in this project. 
<br>
Sensitivity confidence assessments were included to provide an indication of the level of confidence associated with each sensitivity assessment using the MarESA methods. The confidence assessments provides three types of confidence assessments, Quality of Evidence (QoE), Applicability of Evidence (AoE) and Degree of concordance between Evidence (DoE). Each of these confidence assessments were carried out for each of the sensitivity components, namely, Resistance, Resilience and Sensitivity. The QoE provides a measure regard for the origin of the evidence, e.g. peer review journal article, grey literature, expert opinion. The AoE provides a measure of how realistic is it for a given pressure to impact upon a habitat. The DoE provides a measure of the agreement between different evidence sources. The higher the confidence score, the greater the level of confidence in the assessment. Only the quality of evidence (QoE) for overall sensitivity was displayed as a map in this study, but all measures are available for mapping. No attempt was made to amalgamate confidence indices into single measures, as what they represent becomes lost when doing so, especially if this were to be combined with the spatial confidence of the habitat map.

### Marine habitat map
The benthic habitat map used by NE (Marine_Evidence_Base_Internal.gdb, layer = BSH, version: ), was used as the basis to inform the spatial distribution of benthic habitats within English waters for this project. The habitat categories contained within NE's habitat map are based on the EUNIS classification developed in conjunction with the JNCC [@daviesEUNISHabitatClassification2004; @galparsoroUsingEUNISHabitat2012]. The habitat map is continuously updated as new information on habitat becomes available following a well defined process between NE and JNCC. The extent of the habitat map was: -24.2816553949999729,47.9878704700000753 : 3.7191888160000417,64.0702531440000485, in datum World Geodetic System 1984 (WGS84). The habitat map included over a million (1,207,497) polygons, each which have previously been attributed with a habitat type category following the [EUNIS habitat classification](https://www.eea.europa.eu/data-and-maps/data/eunis-habitat-classification). The map below shows the variety of habitats, and the differences in the levels of EUNIS habitats (See Annex for more details). The map also shows that more than one type of habitat may be associated with a given polygon, known as a mosaic habitat. In this study, only the habitat category (EUNIS code) named first within such mosaic habitats categories was used in this study. The decision to use the first named habitat type (EUNIS Code) in mosaic habitats was used based on the notion that it was the most likely habitat where there was uncertainty, or the most abundant within the polygon where these represent true mosaic habitats (Timothy Fegan, Lead Advisor, Marine GI, Evidence Services NE, personal comment). For example, if a polygon had EUNIS code A1.1/A1.2, only A1.1 would have been used. See the habitat map below for UK under the legend which shows a sample from the "HAB_TYPE" column (Figure 2).  Attempting to create sensitivity maps for all possible habitat types listed in the "HAB_TYPE" column in the attribute table was beyond the scope of this project and would result in significant delays, but may be incroporated in future developments of the model where only the habitat type with the maximum sensitivity will be used.
<br>

```{r habmap200, fig.cap= "Figure 2. The benthic habitat map for the United Kingdom from 0 to 200 NM offshore, showing a sample of the EUNIS habitat codes under the map-legend and a range in EUNIS levels spanning from 1 to 6." , echo = FALSE, , out.extra='style="background-color: #FFFFFF; padding:20px; display: inline-block;"'}
rpt_d <- getwd()
...
```
<br>
The EUNIS benthic habitat categories associated with the UK habitat map were associated with the sensitivity assessment of habitats database according to their EUNIS classification codes. By joining these datasets sensitivity maps for benthic habitat to the various pressures and activities were generated. The following steps were taken to produce the habitat sensitivity maps from the aforementioned data sources.
<br>
The habitat map was comprised habitat categories which were of different EUNIS levels (1 - 6) as a result of different amounts of data available for the different areas in English waters. The habitat map and habitat classification system is updated by NE and JNCC as new information becomes available. As such, there is variability in the amount of detail about the habitat (substrate and benthos), as well as variability in confidence between the distint areas on the habitat map (referred to as polygons hereafter). The habitat map is therefore comprised of a patchwork of polygons which may differ in their shape, area and the habitat category (and EUNIS level) which they represent, as well as the level of confidence with which the habitat was category was assigned to it. The confidence associated with habitat classification of each polygon is represented by a MESH (Mapping European Seabed Habitats) score (*Annex MESH confidence*). MESH scores are derived from the confidence associated with different data sources used to inform the classification of the habitat category assigned to a polygon. 

### Addressing the mismatch in EUNIS habitat category levels between assessments and the habitat map.
The habitat map for the UK span the full set of EUNIS levels (1 - 6), while habiat sensitivity assessments held by Natural England were limited EUNIS levels 4 - 6 (Figure 3). Approximately 70 % of the area of the UK waters was mapped at EUNIS level four, approximately 70 % of the polygons constituting the habitat map for the UK were at EUNIS level three (Figure 4). Therefore a significant proportion (70 %) of the mapped area of inshore and offshore habitats corresponded to EUNIS habitat categories which have been assessed for sensitivity, but about 30% of the area included habitat categories which have not had not been assessed (EUNIS level 3 and lower). Overall the majority of the polygons of which the habitat map is comprised are at EUNIS level 3 (Figure 4). These graphs (Figure 4) show that there are a lot of very small polygons at EUNIS level 3 representing the habitat map. The large number of polygons at EUNIS level 1 - 3 which do not have sensitivity assessments required an sensitivity assessments in order to produce a more complete map of habtiat sensitivity. This mismatch between the assessed habitats and mapped habitats was addressed using predictive fine-scale habitat (EUNIS levels 4 - 6) modelling within broad-scale habitats (EUNIS levels 1 - 3). Predictive habitat modelling was based on a dataset which details potential fine-scale habitats which occur within the broader habitat categories within the sub-biogeoregions in the inshore waters of England from 0 to 12 NM. From this work a list of possible fine-scale habitats occuring within broad-scale-mapped habitats within each sub-biogeoregion was developed. From this list of potenital fine-scale habitat categories, the habitat with the highest level of sensitivity was used to represent the sensitivity of that broad-scale habitat on the map. This sub-biogeoregional habitat dataset was based on previous work commisioned to the Marine Biological Association which uses a combination of expert opinion and emperical data [@hiscockAssigningEUNISClassification2016]. There is currently similar work commissioned by JNCC which is identifying fine-scale habitats within broad-scale habits in the offshore (12 - 200 NM). The latter data set will become incorporated into the overall data set in due course, but was not ready for implementation at the time of writing.
<br>
...
rpt_d <- getwd()
eunis_mismatch_img_path <- paste0(rpt_d,"/figures/EUNIS_mismatch_20190514.png")
...
<br>
```{r mapped_eunis_area_polys, fig.cap="Figure 4. The area (in degrees square) and number of polygons per EUNIS level in the Natural England's habitat map for the UK. The red bars in the graphs show EUNIS levels 4 - 6 which have sensitivity assessments, and EUNIS levels 1-3 which do not have sensitivity assessments.", echo = FALSE }
rpt_d <- getwd()
...
### Data processing
GIS steps were used to split the original English waters habitat map into an inshore (0 - 12 NM) and offshore component (12 - 200 NM). All other technical data manipulation was carried out using the R statistical environment in effort to make the data processing transparrent, repeatable and easy to update outputs following changes to the sensitivity assessment database or updates to the benthic habitat map in future.

### GIS steps 
The inshore (0 - 12 NM) and offshore (12 - 200 NM) habitat areas were produced using geoprocessing tools in QGIS (function name stated in bold). A mask was created which delineates the inshore and offshore English territorial waters respectively (Figure 6). The habitat map (Figure 4) was (step 1) separated into the inshore and offshore using intersections (CLIP) with the masks of the inshore and offshore (Figure 6). This newly created inshore habitat layer was (step 2) intersected (INTERSECT)  with the sub-biogeoregional shapefile (Figure 5) associate the sub-biogeoregions  to the individual polygons comprising the inshore habitat map.
<br>
```{r masks, fig.cap = "Figure 6. The mask polygon used to prepare the habitat map to the English inshore (0 - 12 NM) and offshore territorial waters.", echo = FALSE}
rpt_d <- getwd()
mask_path <- paste0(rpt_d,"/figures/masks.png")
#mask_path <- ("F:/projects/marine_biotope_sensitivity/report/figures/masks.png")
knitr::include_graphics(mask_path, dpi = 150)
...
#(File names to be added in the Annex, or flow diagrams: subbiogeoregions_clipped12nm_joined_sbgr_PH_wgs84.shp)
#**Phil to do still: Update the below flow diagram to a more readable version of the data and the processing.**
...
<br>
The offshore habitat map was prepared using geoprocessing tools in QGIS (CLIP) using a mask , to remove all areas outside of English offshore waters, as well as the area inside the English 12 NM boundary, from the UK waters. A column was added to the offshore dataset (built into the R script described below), equivalent to the sub-biogeoregion column added to the inshore habitat map, but here labelling all polygons as "offshore", to allow merging of the end products. The GIS process for the inshore map can be depicted in flow diagram as follows.
<br>
...
```{r GI_process, fig.cap="Figure 7. The GIS processes followed to prepare the data set prior to implementing the R scripts.", echo =FALSE}
rpt_d <- getwd()
...
<br>
All GIS outputs were stored as geopackage files to explore the use of open source standard file formats (and tools) in order to promote their use within the organisation. Geopackages are GIS files which contain a database within which the information (attributes) are associated with the individual habitat polygons.
<br>

### R-code steps
All programming to generate habitat sensitivity layers was carried out using R. The code files are stored on NE's GitHub [webpage](https://github.com/naturalengland/marine_biotope_sensitivity). Here only a high-level overview of how the code works is described. Details about what each section of code does is broadly described in the Annex, and specific details are described within each R-file. The inshore and offshore used two separate sets of code, and run independently, after they were split using the GIS described above. The R scripts developed for processing the inshore and offshore data follow the same steps as described below. In essence the R scripts reads the sensitivity assessments (and associated confidence scores) and GIS data into the R statistical environment. In the R environment the GIS data are associated with the sensitivity assessments. In the inshore the R-code evaluates the fine-scale habitats which may occur within broad-scale habitats, and associates the individual mapped habitat polygons to the fine-scale habitat assessments with the highest sensitivity score within each sub-biogeoregion. The process is repeated for the offshore data, but the code finds the fine-scale "child" benthic habitat with the highest sensitivity for each mapped broad-scale habitat within the entire offshore area. At this stage no sub-biogeoregional information was included in the offshore area and these assessments are likely to over-estimate sensitivity. The data a sets were finally stored as geopackages for the inshore and offshore respectively. 

## Case Study
### Scallop fishing activity data
The spatial match of scallop dredging activity was compared to the distribution of habitat sensitivity maps for 1) abrasion (D6), 2) penetration (D2) and 3) siltation (D5) from dredging (activity code Z10_5). The inshore and offshore areas were analysed seperately to provide an indication of the distribution of fishing effort and habitat sensitvity in these two areas. The dredging activity between stored in file "MMO_UK_VMS_Fishing_Activity.gdb" represents processed Vessel monitoring Data (VMS) previously obtained from the MMO. In this geodatabase the spatial distribution of cumulative dredging effort between 2012-2014 was represented as the number of dredge passes within a square grid with a resolution of 5500 m by 3200 m. The dataset is a pooled dataset including scallop dredging, but also other kinds of dredging data. Areas known to primarily represent dredging activity other than scallop dredging were excluded during a review process. The remaining core areas of interest were cross validated using MMO landings data [website](https://www.gov.uk/government/organisations/marine-management-organisation) and recent report from Cefas on scallop dredging activity [@lawlerAssessmentScallopStock2019]. This process removed areas such as The Wash on the East coast of England where hydraulic dredging is the principal means of dredging.  
Areas with relatively high levels of fishing pressure were extracted from the overall activity map. Areas with relatively high levels of dredging activity were identified by setting a minimum threshold of including cells from the activity map where dredging activity exceeded 20 % of the highest activity value (Figure 7). This was done to restrict the area of investigation to distinct (and disjointed) areas where fishing pressure was greatest. It is acknowledged that there are more recent datasets held by the MMO with greater detail available to separate the different fishing metiers, but this was not available to the case study at the time of writing owing the time pressures assocaited with the project. The data used in this study is a realistic and recent example of the geographic distribution of dredging pressure in the English waters, and deemed sufficiently robust to test the use of fishing effort in relation to habitat sensitivity maps.
Five areas with high levels of scallop dredging were identified for further analysis in relation to habitat sensitivity (Figure 7).
<br>
```{r gis_process_aoi, echo=FALSE}
#**Phil to do: Develop a flow diagram depicting this process for easier reading.**
...
```
<br>
```{r dredge, fig.cap= "Figure 7. Five areas with high levels scallop dredging were identified from the cumulative number of passes of dredgers in English inshore (0 - 12 NM) and offshore (12 - continental shelf) Territorial Waters in the between 2012 and 2014 from Vessel Monitoring System (VMS) data. ", echo = FALSE}
rpt_d <- getwd()
...
The habitat sensitivity within areas of high scallop dredging activity was analysed using a 100 by 100m grid of randomly stratified points within each of the five areas identified as having high levels of scalloping effort. The point-grid was overlaid onto the inshore and offshore benthic habitat sensitivity maps in a GIS, and the underlying habitat sensitivity and fishing activity were obtained where the points intersected these maps.

# Results

## Sensitivity mapping
In total there were 154 valid combinations of benthic habitat sensitivity assessments against 39 pressures from each the ten fishing activities, for the inshore and for the offshore respectively. I.e. Therefore a total of 308 habitat sensitivity maps for the inshore and offshore waters. Not all activities-pressure-habitat combinations have valid interactions, and therefore the total was not 390 per inshore/offshore data set. Each mapped habitat sensitivity was accompanied by the same number of confidence assessments and the assessed fine-scale habitat type (child of broader habitat type). Overall a 924 data columns representing habitat sensitivity, confidence assessment and assessed fine-scale habitat were developed for the inshore and offshore. The mappable data columns were stored in two files, one for the offshore and another for the inshore as geopackages with a spatial resolution and level of detail of the benthic habitat map which mirrors the original habitat map.

## Case study results
The spatial distribution of benthic habitat sensitivity to abrasion, penetration and siltation from dredging is shown in Figure 8, 9 and 10, respectively. The offshore is characterized by large contiguous (connected) areas of medium or low level sensitivity. The inshore benthic habitat is characterized by a patchwork of habitat sensitivities including high to low sensitive habitats. For example, the offshore area in the English Channel is dominated by low sensitivity habitat, while the inshore area in the English Channel has several areas of medium to high sensitivity. 


<br>
```{r hab_sens_dredge_abras, fig.cap= "Figure 8: The benthic habitat sensitivity to abrasion from dredging activities in the English Territorial Waters (0 NM - continental shelf).", echo = FALSE}
rpt_d <- getwd()
hs_drdg_img_path <- paste0(rpt_d,"/figures/Habitat_sensitivity_abrasion_dredging_z10p5_d6.png")
...
<br>
```{r hab_sens_dredge_penet, fig.cap= "Figure 9: The benthic habitat sensitivity to penetration from dredging activities in the English Territorial Waters (0 NM - continental shelf).", echo = FALSE}
rpt_d <- getwd()
hs_drdg_img_path <- paste0(rpt_d,"/figures/hab_sens_dredge_penetration_z10p5_d2.png")
...
<br>
```{r hab_sens_dredge_silt, fig.cap= "Figure 10: The benthic habitat sensitivity to siltation from dredging activities in the English Territorial Waters (0 NM - continental shelf).", echo = FALSE}
rpt_d <- getwd()
hs_drdg_img_path <- paste0(rpt_d,"/figures/hab_sens_dredge_siltation_z10p5_d5.png")
...
```{r assessed_habs_inshore_abras, fig.cap= "Figure 11. The fine-scale benthic habitats with maximum habitat sensitvity occuring within broader mapped habitats which were used in sensitivity assessments against abrasion in the English Territorial Waters (0NM - continental shelf).", echo = FALSE}
rpt_d <- getwd()
...
```{r assessed_habs_inshore_penet, fig.cap= "Figure 12. The fine-scale benthic habitats with maximum habitat sensitvity occuring within broader mapped habitats which were used in sensitivity assessments against penetration in the English Territorial Waters (0NM - continental shelf).", echo = FALSE}
rpt_d <- getwd()
hab_assessed_img_path <- paste0(rpt_d,"/figures/fine_assessed_habs_England.png")
...
<br>
```{r assessed_habs_inshore_silt, fig.cap= "Figure 13. The fine-scale benthic habitats with maximum habitat sensitvity occuring within broader mapped habitats which were used in sensitivity assessments against siltation in the English Territorial Waters (0NM - continental shelf).", echo = FALSE}
rpt_d <- getwd()
hab_assessed_img_path <- paste0(rpt_d,"/figures/fine_assessed_habs_England.png")
...
## Confidence measure - Quality of Evidence (QoE)
The confidence of the sensitivity assessments for the inshore and offshore based on the QoE is shown in Figure 10. The confidence map showed that generally the quality of evidence was higher for habitats assessed in the inshore than offshore areas, but the offshore is subject to change following an update to the habitats used during assessments. The English channel generally had relatively high levels of confidence associated with sensitivity assessments.

<br>

```{r conf_map_abras, fig.cap="Figure 14. Map showing the spatial distribution of confidence of habitat sensitivity assessments (based on Quality of Evidence) against abrasion from dredging in English Territorial Waters (0 - continental shelf).", echo = FALSE}
rpt_d <- getwd()
conf_map_img_path <- paste0(rpt_d,"/figures/confidence_in_off_shore_dredge_abras_z10p5_d6.png")
include_graphics(conf_map_img_path, dpi = 150)
```

<br>
```{r conf_map_penet, fig.cap="Figure 15. Map showing the spatial distribution of confidence of habitat sensitivity assessments (based on Quality of Evidence) against penetration from dredging in English Territorial Waters (0 - continental shelf).", echo = FALSE}
rpt_d <- getwd()
conf_map_img_path <- paste0(rpt_d,"/figures/confidence_in_off_shore_dredge_penetrat_z10p5_d2.png")
include_graphics(conf_map_img_path, dpi = 150)
```
<br>
```{r conf_map_silt, fig.cap="Figure 16. Map showing the spatial distribution of confidence of habitat sensitivity assessments (based on Quality of Evidence) against siltation from dredging in English Territorial Waters (0 - continental shelf).", echo = FALSE}
rpt_d <- getwd()
conf_map_img_path <- paste0(rpt_d,"/figures/confidence_in_off_shore_dredge_siltation_z10p5_d5.png")
include_graphics(conf_map_img_path, dpi = 150)
```
<br>
...
Developing a script which could automate the process improved made the methods used transparent and repeatable. It is therefore also open to further improvement in future, and can facilitate an update in the underlying data and can be extended to all operations for which Natural England provides conservation advice.

A second key challenge to the modelling was dealing with the mismatch in mapped EUNIS habitats and level of habitats included in sensitivity assessments. The sub-biogeoregional appraoch used in this study 


## Conclusion
The use of habitat sensitivity maps were shown to identify the impacts of the scallop dredging fishery on the benthic habitat in England. Further development of these data sets and analytical routines could therefore provide useful information to marine mangers and it may facilitate the prevention of damaging displacement of fishing effort. Furthermore, England's marine environment is subject to a vast array of operations in addition to fishing which impact the marine environment, such as marine aggregate dredging, development of renewable energy and risks of pollution from oil spills among many others. The use of habitat sensitivity maps at the fine-scale presented in this study is therefore an important new source of information to inform decisions where the exploitative activities and infrastructure development is constantly weighed up against their impacts on the environment [@walportForesightFutureSea2017]. 
