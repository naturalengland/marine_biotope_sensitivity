...
### Habitat sensitivity interaction with scallop dredging

The habitat sensitivity within areas of high scallop dredging activity was anlaysed using a 100 by 100m grid of randomly stratified points within each high activity area. The point-grid was overlaid onto the inshore and offshore benthic habiat sensitivity maps in a GIS, and the underlying  habitat sensitivity and fishing activity was obtained where the points intersected these maps. 
...
hab_sens_in_aois_img_path <- "F:/projects/marine_biotope_sensitivity/report/figures/habitat_sensitivity_inside_dredged_areas.png"
...
```{r high_and_medium_sensitive_table, fig.cap="Table 8. List of high and medium sensitive habitats under high levels of scallop dredging activity between 2009 and 2014 in England.", echo = FALSE}
hm_sens_habs <- readRDS("./tables/high_and_medium_sensitive_habitats.RDS")
hm_sens_habs %>%
...
img_path <- "F:/projects/marine_biotope_sensitivity/report/figures/falmouth_example.png"
