...
## Pressure
Pressure is the force of stress exerted by an activity on marine benthic habitats. Every activity may be associated with numerous pressures which act simultaneously on these habitats. The nature of the pressure is determined by the activity type, intensity and distribution [@robinsonMarineAssessmentMonitoring2010]. Pressures are standardised according to a  benchmark. A benchmark is a set level at which there are known effect and habitats or species. See the MarESA methods for more detail.
...
## Study Area
Marine habitat sensitivity maps were generated for the United Kingdom's Exclusive Economic Zone (EEZ), from the shoreline to 200 NM offshore. The sensitivity maps were generated in two independent steps for two geographical adjacent areas: First for 0 - 12 NM offshore for English territorial waters (area in light blue in Figure 1), and second, the 12 - 200 NM English offshore. The second step included the Devolved Administration's waters from 0 - 200 NM for (Figure 1). Note that Devolved Administrations were produced as an artefact of the process, and no attempt was made to analyse or interpret this data. These areas will subsequently be removed from outputs.
...
# Results
Eight areas of interest were identified from the spatial distribution of dredging effort.
...
*3. Overlay the MPAs, and repeat the above? - may exlcude*
